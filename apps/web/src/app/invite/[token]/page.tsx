...
export default function InvitePage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <h2 className="text-xl text-gray-700 dark:text-gray-300">正在验证身份...</h2>
        </div>
      </div>
    );
  }
  ...
  async function handleJoin() {
    ...
    try {
      ...
      setError(err.message || '加入工作区失败，邀请链接可能无效或已过期。');
      setJoining(false);
    }
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-md w-full text-center">
        <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">工作区邀请</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          您已被邀请加入 DocStudio 工作区。
        </p>
