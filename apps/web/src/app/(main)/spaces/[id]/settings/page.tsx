      ...
      <div className="w-full animate-pulse">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-xl p-6 space-y-6">
          <div>
            ...
            <div className="h-10 w-full bg-gray-100 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700"></div>
          </div>

          <div>
            <div className="h-4 w-12 bg-gray-200 dark:bg-gray-700 rounded mb-2"></div>
            <div className="h-24 w-full bg-gray-100 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-700"></div>
          </div>
